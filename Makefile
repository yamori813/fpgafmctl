...
AVRDUDE_PROGRAMMERID=$(APPPATH)/$(TOOLPATH)/bin/avrdude
...
AVRDUDE_FUSES=-U lfuse:w:0xE2:m -U hfuse:w:0xdf:m -U efuse:w:0xff:m
...
OBJDUMP=$(APPPATH)/$(TOOLPATH)/bin/avr-objdump
...
size:
	$(APPPATH)/$(TOOLPATH)/bin/$(SIZE) main.o
